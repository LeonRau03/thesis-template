...
%%% Absatzlayout nach IU-Richtlinie
...
\raggedbottom % Verhindert ungleichmäßige vertikale Abstände durch vertikalen Stretch
...
\usepackage{pifont}	   % Zusätzliche Symbole (z.B. Haken/Kreuz)
