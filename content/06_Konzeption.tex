...
\caption{Logische Zielarchitektur der Observability-Pipeline fuer frag.jetzt. Das Schichtenmodell zeigt den Datenfluss von der Instrumentierung ueber Sammlung und Speicherung bis zur Auswertung. Gestrichelte Querverbindungen kennzeichnen Korrelationsmechanismen zwischen den Speicher-Backends. Quelle: Eigene Darstellung}
...
\begin{table}[htbp]
\centering
\caption{Serviceübergreifende Signal-Matrix mit Zuordnung von Dienst, Golden Signal, konkreter Messgröße, Erhebungszweck und primärer Stakeholder-Rolle. Quelle: Eigene Darstellung}
